...
class SalesBox extends StatelessWidget {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: GestureDetector(
                  ...
                  child: Text('更多福利 >', style: TextStyle(color: Colors.white, fontSize: 12),),
                ),
              )
  ...
  _doubleItems(BuildContext context, CommonModel leftCard, CommonModel rightCard, bool big, bool last) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
